...
use LidyaPos\Theme\Facades\AdminBarFacade;
use LidyaPos\Theme\Facades\ThemeOptionFacade;
...
if (!function_exists('theme_option')) {
    /**
     * @return \LidyaPos\Theme\ThemeOption|string
     */
...
if (!function_exists('admin_bar')) {
    /**
     * @return LidyaPos\Theme\Supports\AdminBar
     */
    function admin_bar()
    {
